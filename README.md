...
| **`html-report`** | EndoRobotics 표준 HTML 보고서 빌더. 검증된 디자인 시스템(표지+한 줄 결론·sticky 목차·핵심 강조·펼침 카드·SVG 도식·라이트박스), base64 단일 파일 | ✅ v0.1.0 | [`skills/html-report/`](skills/html-report/) |
